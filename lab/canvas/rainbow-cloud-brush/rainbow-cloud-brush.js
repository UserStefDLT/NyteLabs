...
function BrushActive(){
    Settings(" ");
    let btn = document.getElementById('BrushActive');
    if(btn.dataset.active == "1"){
        btn.dataset.active = "0";
        btn.innerText = "Brush Off";
    } else {
        btn.dataset.active = "1";
        btn.innerText = "Brush On"
    }
    btn.classList.toggle('kbd-disable');
    // btn.dataset.active == "1" ? btn.dataset.active = "0" : btn.dataset.active = "1";
    // btn.dataset.active == "1" ? btn.innerText = "Brush On" : btn.innerText = "Brush Off";
}
function BrushCanvas(){
    Settings("h");
    Settings("l");
}
function CloudEraser(){
    Settings("e");
    let btn = document.getElementById('CloudEraser');
    btn.classList.toggle('kbd-disable');
}
